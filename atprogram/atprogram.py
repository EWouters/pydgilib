...
def atprogram(project_path=None, device_name="ATSAML11E16A", verbose=0,
    ...
    .. warning:: \
                 **WARNING**: This function requires Atmel Studio to be installed. The
                 last version of Atmel Studio that proved to work currently
                 is 7.0.

    .. warning:: \
                 **WARNING**: This function works only on projects that have been **built**
                 at least *once*. The function makes use of the `makefiles` 
                 that are only generated by Atmel Studio.
